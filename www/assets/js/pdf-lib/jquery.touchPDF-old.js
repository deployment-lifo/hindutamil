		...
		*/
		...
		function initDom() {
			...
			if (!options.disableZoom) {
				...
				var el = document.querySelector('div.pdf-drag .pdf-canvas');
		...
		*/
		function renderPage () {
			...
			pdfDoc.getPage(pageNumRendering).then(function(page) {
				...
				var bookHeight=$('#book-reader').height();
				var bookWidth=$('#book-reader').width();
				...
				$(".pdf-canvas").css("transform", "scale(0.25)").css("transform-origin", "top left");
