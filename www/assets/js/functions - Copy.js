var androidVersion = "2.0.2";
var iosVersion = "2.0.1";
...
function appendHomePage(data,val) {
	...
	var content = "";
	//alert(localStorage.getItem('deviceDetails'));
	...
	for (var i = 0; i < data.length; i++) {
		if(data[i].type == 'type1') {
			...
			content += "<div id='div-gpt-ad-1605624284210-0' class='text-center advet_bg' ><script>refreshAds('home_page_ad_1');</script></div>";
			
			content += '<div class="block-title"><h2>'+data[i].title_ta+'</h2></div>';
			...
			if(post.length > 0) {
				...
				for(var j = 0;j < totLen;j++) {
					...
					if(j == 0) {
						cont += '<div class="col-100'+classs+'"><div class="card news news_lg"><a data-mid="0" data-aid="'+post[j].aid+'" href="javascript:;" class="card-header cover-img align-items-flex-end navToNewsDetailPage"><img src="'+post[j].img.replace("thumb", "large")+'" onerror="this.src=\'assets/images/no-img.jpg\'"/></a><div class="card-content card-content-padding"><a data-mid="0" data-aid="'+post[j].aid+'" href="javascript:;" class="news-title navToNewsDetailPage">'+post[j].title_ta.substr(0,70)+'...</a><p class="news-desc">'+post[j].desc.substr(0,strVal)+'...</p></div></div></div>';
					} else if(deviceModel.includes('iPad') && j == 1) {
						cont += '<div class="col-100'+classs+'"><div class="card news news_lg"><a data-mid="0" data-aid="'+post[j].aid+'" href="javascript:;" class="card-header cover-img align-items-flex-end navToNewsDetailPage"><img src="'+post[j].img.replace("thumb", "large")+'" onerror="this.src=\'assets/images/no-img.jpg\'"/></a><div class="card-content card-content-padding"><a data-mid="0" data-aid="'+post[j].aid+'" href="javascript:;" class="news-title navToNewsDetailPage">'+post[j].title_ta.substr(0,70)+'...</a><p class="news-desc">'+post[j].desc.substr(0,strVal)+'...</p></div></div></div>';
					} else {
						//cont += '<div class="col-100 medium-40"><div class="list media-list news-list"><ul><li><a data-mid="0" data-aid="'+post[j].aid+'" href="/news-detail/1/'+post[j].aid+'" class="item-link item-content"><div class="item-media "><img src="'+post[j].img.replace("thumb", "large")+'" width="80" onerror="this.src=\'assets/images/no-img.jpg\'"/></div><div class="item-inner"><div class="item-text">'+post[j].title_ta+'</div></div></a></li></ul></div></div>';
						text += '<li><a data-mid="0" data-aid="'+post[j].aid+'" href="javascript:;" class="item-link item-content navToNewsDetailPage"><div class="item-media "><img src="'+post[j].img.replace("thumb", "large")+'" width="80" onerror="this.src=\'assets/images/no-img.jpg\'"/></div><div class="item-inner"><div class="item-text">'+post[j].title_ta+'</div></div></a></li>';
					}
				}
				text += '</ul></div></div>';
				cont += text+'</div>';
		...
		if(data[i].type == 'type10') {
			...
			if(post.length > 0) {
				for(var j = 0;j < post.length;j++) {
					content += '<div class="inHouseAd advet_bg">'+post[j].tag+'</div>';
				}
			}
		}
		if(data[i].type == 'type2') {
			var post = data[i].post;
	        if(post.length > 0) {
	          // localStorage.setItem('videos',JSON.stringify(post));
	          //content += '<a href="/videos/1"><div class="block-title mn playHomepPageVideo"><h2>'+data[i].title_ta+'</h2></div><div class="playHomepPageVideo"><div data-pagination={"el": ".swiper-pagination"} data-space-between="10" data-slides-per-view="auto" data-centered-slides="true" class="swiper-container swiper-init album-swiper"><div class="swiper-pagination"></div><div class="swiper-wrapper"><div class="swiper-slide" id="pb-standalone-dark"><div class="card album-card"><div style="background-image:url('+post[0].img+')" class="card-header align-items-flex-end"></div><div class="card-content card-content-padding"><h3>'+data[i].title_ta+'</h3></div></div></div></div></div></div></a>';
	          //content += '<a href="/videos/1"><div class="block-title mn playHomepPageVideo"><h2>'+data[i].title_ta+'</h2></div><div class="card album-card"><div style="background-image:url('+post[0].img+')" data-id="'+i+'" data-video="'+post[i].video_id+'" class="card-header align-items-flex-end cover-img playVideo"><div class="play-icon"><i class="fa fa-play"></i></div></div><div class="card-content card-content-padding"><h3 class="mn">'+data[i].title_ta+'</h3><p>Posted On <span>'+post[i].created+'</span></p></div></div></a>';
	        }
		}
		if(data[i].type == 'type3') {
			if(data[i].title_ta == "சினிமா") {
				content += "<div id='div-gpt-ad-1605624482177-0 advet_bg' class='text-center' ></div>";
				//content += "<div id='div-gpt-ad-1605624482177-0' class='text-center advet_bg' ><script>refreshAds('home_page_ad_2');</script></div>";
			}
			if(data[i].title_ta == "விளையாட்டு") {
				content += "<div id='div-gpt-ad-1605624526675-0 advet_bg' class='text-center' ></div>";
				//content += "<div id='div-gpt-ad-1605624526675-0' class='text-center advet_bg' ><script>refreshAds('home_page_ad_3');</script></div>";
			}
			if(data[i].title_ta == "உலகம்") {
				content += "<div id='div-gpt-ad-1605624566043-0 advet_bg' class='text-center' ></div>";
				//content += "<div id='div-gpt-ad-1605624566043-0' class='text-center advet_bg' ><script>refreshAds('home_page_ad_4');</script></div>";
			}
			if(data[i].title_ta == "இணைப்பிதழ்கள்") {
				content += "<div id='div-gpt-ad-1605624326531-0 advet_bg' class='text-center' ></div>";
				//content += "<div id='div-gpt-ad-1605624326531-0' class='text-center advet_bg' ><script>refreshAds('home_page_ad_5');</script></div>";
			}
			content += '<div class="block-title"><h2>'+data[i].title_ta+'</h2></div>';
			var post = data[i].post;
			var cont = '';
			if(post.length > 0) {
				...
				for(var j = 0;j < post.length;j++) {
					var classs = (j<2)?((totLen == 1)?' medium-100':' medium-50'):'';					
					if(j == 0) {
						cont += '<div class="col-100 '+classs+'"><div class="card news news_lg"><a data-aid="'+post[j].aid+'" href="javascript:;" class="card-header cover-img align-items-flex-end navToNewsDetailPage"><img src="'+post[j].img.replace("thumb", "large")+'" onerror="this.src=\'assets/images/no-img.jpg\'"/></a><div class="card-content card-content-padding"><a data-aid="'+post[j].aid+'" href="javascript:;" class="news-title navToNewsDetailPage">'+post[j].title_ta.substr(0,70)+'...</a><p class="news-desc">'+post[j].desc.substr(0,strVal)+'...</p></div></div></div>';
					} else if(deviceModel.includes('iPad') && j == 1) {
					//} else if(j == 1) {
						cont += '<div class="col-100'+classs+'"><div class="card news news_lg"><a data-aid="'+post[j].aid+'" href="javascript:;" class="card-header cover-img align-items-flex-end navToNewsDetailPage"><img src="'+post[j].img.replace("thumb", "large")+'" onerror="this.src=\'assets/images/no-img.jpg\'"/></a><div class="card-content card-content-padding"><a data-aid="'+post[j].aid+'" href="javascript:;" class="news-title navToNewsDetailPage">'+post[j].title_ta.substr(0,70)+'...</a><p class="news-desc">'+post[j].desc.substr(0,strVal)+'...</p></div></div></div>';
					} else {
						//cont += '<div class="col-100 medium-40"><div class="list media-list news-list"><ul><li><a href="/news-detail/1/'+post[j].aid+'" class="item-link item-content"><div class="item-media"><img src="'+post[j].img.replace("thumb", "large")+'" onerror="this.src=\'assets/images/no-img.jpg\'" width="80"/></div><div class="item-inner"><div class="item-text">'+post[j].title_ta+'</div></div></a></li></ul></div></div>';
						text += '<li><a data-mid="0" data-aid="'+post[j].aid+'" href="javascript:;" class="item-link item-content navToNewsDetailPage"><div class="item-media "><img src="'+post[j].img.replace("thumb", "large")+'" width="80" onerror="this.src=\'assets/images/no-img.jpg\'"/></div><div class="item-inner"><div class="item-text">'+post[j].title_ta+'</div></div></a></li>';
					}
				}
				text += '</ul></div></div>';
	...
	// app.preloader.hide();
	setTimeout(function(){
		/*console.log(typeof(ptrTabs));
		if(typeof(ptrTabs)!='undefined' && ptrTabs!='')
			app.ptr.destroy('.ptr-content');
		ptrTabs=app.ptr.create('.ptr-content');*/
		homePageAds();
	},1500);
	//$("#sizeinfo").css("z-index", "999999");
	 // console.log($('#sizeinfo').offset().top);
	 // console.log($('#sizeinfo').offset().left);
}
		...
		if(data == null) {
			...
			for(var i = 0;i < data.length;i++) {
				if(i == 0 && scrollPageNo == 1) {
					content += '<div class="block-title"><h2>'+data[0].cate_ta+'</h2></div>';
					content += '<div class="card news news_lg"><a href="javascript:;" data-aid="'+data[i].aid+'" class="navToNewsDetailPage card-header cover-img align-items-flex-end"><img src="'+data[i].img.replace('thumb','large')+'" onerror="this.src=\'assets/images/no-img.jpg\'"/></a><div class="card-content card-content-padding"><a data-aid="'+data[i].aid+'" href="javascript:;" class="news-title navToNewsDetailPage">'+data[i].title_ta+'</a><p class="news-desc">'+data[i].desc_ta+'</p></div></div>';
				} else {
					content += '<div class="list media-list news-list"><ul><li><a href="javascript:;" data-aid="'+data[i].aid+'" class="item-link item-content navToNewsDetailPage"><div class="item-media"><img src="'+data[i].img.replace('thumb','large')+'" width="80" onerror="this.src=\'assets/images/no-img.jpg\'"/></div><div class="item-inner"><div class="item-text">'+data[i].title_ta+'</div></div></a></li></ul></div>';
				}						
			}
...
function triggerHomeDetails(page) {	
	...
	var data = {key:accessToken,type:'home',page:scrollPageNo};
...
function getOtherPageDetails(id,mId,cId,sId) {
	...
	if($($('#getOtherPages[data-cid="'+cId+'"]').data('tab')).html()=='')
	{
...
function getNewsDetails(data) {
	...
	$('.addBottomTab').html('<a href="/" class="tab-link removeTabLocalStorage"><i class="icon fa fa-home"></i><span class="tabbar-label">முகப்பு</span></a><a href="javascript:;" data-aid="'+data.aid+'" class="tab-link sheet-open navToCommentAddPage"><i class="icon fa fa-comments"></i><span class="tabbar-label">கருத்து</span></a><a href="javascript:;" class="tab-link sheet-open comment addEmotesFromArticlePage"><i class="icon fa fa-thumbs-up"></i><span class="tabbar-label">விருப்பம் </span></a><a class="tab-link share-link shareForAll" href="#"><i class="icon fa fa-share-alt"></i><span class="tabbar-label">பகிர்</span></a>');
	// alert(0);
			...
			success:function(res) {
				if(res.msg == 'success'){ 
					...
					if(data != null) {
						...
						var attribute = localStorage.setItem('offlineStory',JSON.stringify({aid:data.aid,cid:data.cid,category:data.cate_ta,web_url:data.web_url,title:data.title_ta,description:data.desc_ta+data.content,image:data.img,author:data.author,created:data.created}));
						var emoteSum = 0;
						...
						var content = '';
						var pass = {aid:data.aid,a_url:data.web_url,a_title:data.title_ta,desc:data.desc_ta};
						...
						$('.page-current .newsDetailDescription').html('<div id=\'div-gpt-ad-1605624597553-0\' class=\'text-center\' ></div><div style="overflow-x:auto;">'+data.content+'</div>');
		...
		success:function(res) {
			...
			if(res.msg == 'success') {
				...
				if(data != null) {
					if(data.length > 0) {
						for (var i = 0; i < data.length; i++) {
							content += '<li><a href="javascript:;" data-aid="'+data[i].aid+'" class="item-link item-content navToNewsDetailPage"><div class="item-media "><img src="'+data[i].img+'" onerror="this.src=\'assets/images/no-img.jpg\'"  width="80"/></div><div class="item-inner"><div class="item-text">'+data[i].title_ta+'</div></div></a></li>';
						}
					}
					content += "<div id='div-gpt-ad-1605624566043-2' class='text-center' ><script>refreshAds('article_page_ad_5');</script></div>";
	...
	$.ajax({
		...
		success:function(res) {
			if(res.msg == 'success') {
				//$('.appendAllMenus').html('');
				var data = res.data;
				var content = '<ul><li><a href="javascript:;" data-mid="1" data-cid="0" data-sid="0" class="panel-close item-link item-content moveToTab"><div class="item-media"><i class="fa fw fa-home"></i></div><div class="item-inner"><div class="item-title">முகப்பு</div></div></a></li><li><a href="/e-subscription/" class="panel-close item-link item-content"><div class="item-media"><i class="fa fw fa-laptop"></i></div><div class="item-inner"><div class="item-title">இ-பேப்பர்</div></div></a></li>';				
				for(var i = 0;i < data.length;i++) {
					var menu = data[i].sub_menus;
					var subMenu = '';
					...
					if(menu.length > 0) {
						...
						if(data[i].mid =='2' && data[i].cid == 0) {
							var userDetails = JSON.parse(localStorage.getItem('userDetails'));
							//if(userDetails != null && (typeof(userDetails.user_access) != 'undefined') && (userDetails.user_access.emagazine == 1)) {
		...
		success:function(res) {
			...
			if(res.msg == 'success') {
				if(res.data.length > 0) {
					var data = res.data;
					for (var i = 0; i < data.length; i++) {
						content += '<div class="col-100 medium-50"><div class="card news news_lg"><a data-aid="'+data[i].aid+'" href="javascript:;" class="card-header cover-img align-items-flex-end navToNewsDetailPage"><span class="category">'+data[i].cate_ta+'</span> <img src="'+data[i].img+'" onerror="this.src=\'assets/images/no-img.jpg\'"/></a><div class="card-content card-content-padding"><a href="javascript:;" data-aid="'+data[i].aid+'" class="news-title navToNewsDetailPage">'+data[i].title_ta+'</a></div><div class="card-footer"><a href="javascript:void(0)" data-aid="'+data[i].aid+'" data-cid="'+data[i].cid+'" class="link deleteBookMark"><i class="fa fa-trash"></i> Delete</a><a href="javascript:void(0)" data-msg="'+data[i].title_ta+'" data-url="'+data[i].web_url+'" class="link shareLink"><i class="fa fa-share-alt"></i> Share</a></div></div></div>';
					}
	...
	fetchArticleDetails(id,function(res) {
		...
		if(res.length > 0) {
			for(var i = 0;i < res.length;i++) {
				content += '<div class="col-100 medium-50"><div class="card news news_lg"><a data-aid="'+res[i].aid+'" href="javascript:;" class="card-header cover-img align-items-flex-end navToNewsDetailPage"><span class="category">'+res[i].category+'</span><img src="'+res[i].image+'" onerror="this.src=\'assets/images/no-img.jpg\'"/> </a><div class="card-content card-content-padding"><a href="javascript:;" data-aid="'+res[i].aid+'" class="news-title navToNewsDetailPage">'+res[i].title+'</a></div><div class="card-footer"><a href="javascript:void(0)" data-aid="'+res[i].aid+'" data-id="'+res[i].id+'" class="link deleteOfflineStory"><i class="fa fa-trash"></i> Delete</a><a href="javascript:void(0)" data-msg="'+res[i].title+'" data-url="'+res[i].web_url+'" class="link shareLink"><i class="fa fa-share-alt"></i> Share</a></div></div></div>';
			}
			$('.appendSavedStory').html(content);
		} else {
		...
		success:function(res) {
			...
			if(res.msg == "success") {
				 ...
				 if(data != null) {
				 	if(data.length > 0) {
					 	for(var i = 0;i < data.length;i++) {
					 		content += '<div class="col-100 medium-50 large-33 breakWord"><div class="card news news_lg"><a data-aid="'+data[i].aid+'" href="javascript:;" class="card-header cover-img align-items-flex-end navToNewsDetailPage"><img src="'+data[i].img.replace('medium','large')+'" onerror="this.src=\'assets/images/no-img.jpg\'"/></a><div class="card-content card-content-padding"><a href="javascript:;" data-aid="'+data[i].aid+'" class="news-title navToNewsDetailPage">'+data[i].title_ta+'</a><p class="news-desc">'+data[i].desc_ta+'</p></div></div></div>';
				...
				if(data.length > 0) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						if(i == 0) {
							...
							content += '<div class="list media-list news-list"><ul><li><a href="/kamadenu-detail/2/'+data[i].issue_id+'" class="item-link item-content"><div class="item-media"><img src="'+data[i].img.replace('medium','large')+'" width="80" onerror="this.src=\'assets/images/no-img.jpg\'"/></div><div class="item-inner"><div class="item-text">'+data[i].name+'</div></div></a></li></ul></div>';
						}
...
function notificationSettings() {
	...
	if(noti != null) {
		...
		notiSet = noti;
		console.log(notiSet);
		/*if(notificationToggle == 'false' || notificationToggle == false) {
			$('input[name="demo-checkbox[]"]:checked').each(function(index,value){
...
function createGoogleAds() {
	...
	var admobid = {};
	 ...
	 if(moment().unix()>='1613302284' && (device.model.includes('iPad')))
	 {
		if(typeof(AdMob) != 'undefined') {
			AdMob.createBanner( {
			adId:admobid.banner, 
...
function navigateBack() {
	...
	console.log('url',url);
	if(url != '' && url != '/' && url != app.views.main.router.url) {
		history.back();
	} else {
		forceBack();
	}
...
function getSettings() {
	...
	if(typeof(cordova) != 'undefined') {		
		if(cordova.platformId == 'ios') {
			...
			var content = '<li><label class="item-radio item-content"><input type="radio" name="my-radio" value="radio-1"/><i class="icon icon-radio"></i><div class="item-inner"><div class="item-title">Internal Storage</div></div></label></li>';
			if(typeof(cordova.file.externalSdCardDirectory) != 'undefined') {
				content += '<li><label class="item-radio item-content"><input type="radio" name="my-radio" value="radio-2" checked/><i class="icon icon-radio"></i><div class="item-inner"><div class="item-title">SD Card</div></div></label></li>';
			}
...
function fileDownLoadAndroid(obj,callback) {
	...
	var path = '';
	cordova.plugins.diagnostic.requestExternalStorageAuthorization(function(success) {
		path = ((success == cordova.plugins.diagnostic.permissionStatus.GRANTED) && typeof(cordova.file.externalSdCardDirectory) != 'undefined') ? cordova.file.externalSdCardDirectory : cordova.file.dataDirectory;
		console.log(cordova.file);
		var userDetails   = JSON.parse(localStorage.getItem('userDetails'));
		var file_name = generateKeyWord(6);
		var password = generateKeyWord(6);
			...
			fileTransfer.download(
				...
				function(entry) {
					...
					fileEncrption({file_name:file_name+'.ara',password:password});
					 ...
					 saveElibrary({file_name:file_name+'.ara',image:obj.image,file_password:obj.password,file_path:entry.toURL(),file_extention:obj.file_extention,file_id:obj.issue_id,type:obj.type,title:obj.title,password:password,user_id:userDetails.user_id},function(res) {
							app.preloader.hide();
						callback(res);
					});	
				...
				if(res.msg == "success") {
					...
					if(data != null && data.length > 0) {
						...
						for(var i = 0;i < data.length;i++) {
							...
							var button = '<button class="button button-fill button-small button-block color-blue emagazineButton viewMagzineDetail" '+attr+' data-type="read">Read Now</button>';
							if(data[i].is_open == 1) {
								if($.inArray((data[i].issue_id),existingArray) != -1) {
									button = '<button class="button button-fill button-small button-block color-red emagazineButton viewMagzineDetail" '+attr+' data-type="stored">Saved</button>';
								} else {
									button = '<button class="button button-fill button-small button-block color-green emagazineButton viewMagzineDetail" '+attr+' data-type="save">Save Offline</button>';
								}
							}
							...
							content += '<div class="col-50 medium-25" '+attr+'><div class="econtent"><a href="javascript:;" class="epaper"><img src="'+data[i].img.replace('medium','large')+'" '+attr+' class="viewEmagaZine" alt="" /></a><label class="ename">'+data[i].date+' <a href="javascript:;" class="popover-open" data-popover=".popover-viewer""></a></label>'+button+'</div></div>';
						}
						if(obj.show == 1) {
					...
					if(res.msg == "success") {
						...
						if(purBook != null) {
							...
							for(var j = 0;j < purBook.length;j++) {
								...
								var button = '<button class="button button-fill button-small button-block color-blue ebookbutton viewEpubFile" data-type="read" '+attr+'>Read Now</button>';
								if(purBook[j].is_open == 1) {
									if($.inArray((purBook[j].issue_id),existingArray) != -1) {
										button = '<button class="button button-fill button-small button-block color-red ebookbutton viewEpubFile" data-type="stored" '+attr+'>Saved</button>';
									} else {
										button = '<button class="button button-fill button-small button-block color-green ebookbutton viewEpubFile" data-type="save" '+attr+'>Save Offline</button>';
									}
								}
								purchasedBooks += '<div class="col-50 medium-25"><div class="econtent"><a href="javascript:;" class="epaper"><img src="'+purBook[j].img.replace('thumb','large')+'" onerror="this.src=\'assets/images/no-img.jpg\'" class="viewEBookDetail" '+attr+' alt=""></a><label class="ename">'+purBook[j].issue_name.substr(0,30)+'</label>'+button+'</div></div>';
							}
							purchasedBooks += '</div>';
						}
		...
		if(type == 'paper') {
			...
			if(resp.length > 0) {
				...
				for(var i = 0;i < data.length;i++) {
					...
					if(typeof(data[i].file_date) != 'undefined') {
						...
						//dat = (fDate[1] < 10) ? '0'+fDate[1] : fDate[1];
						dat = fDate[1];
						if(fDate[1].length == 1) {
							dat = '0'+fDate[1];
						}
					...
					//<button class="button button-fill button-small button-block color-red moveFileToDir" data-type="paper" data-file-name="'+data[i].file_name+'" data-password="'+data[i].password+'">Move</button>
					...
					content += '<div class="col-50 medium-25"><div class="econtent"><a href="javascript:;" class="img-height epaper viewElibrary" '+attr+'><img src="'+data[i].image+'" onerror="this.src=\'assets/images/no-img.jpg\'" class="" alt=""/></a><label class="ename">'+data[i].title.substr(0,30)+' '+convertMonth(finDate)+'</label>'+button+'</div></div>';
				}
			} else {
				content += '<div class="no-record">No records found</div>';
			}
			...
			if(resp.length > 0) {
				...
				for(var i = 0;i < data.length;i++) {
					...
					content += '<div class="col-50 medium-25"><div class="econtent"><a href="javascript:;" class="epaper viewElibrary" '+attr+'><img src="'+data[i].image+'" onerror="this.src=\'assets/images/no-img.jpg\'" class="" alt=""/></a><label class="ename">'+data[i].title.substr(0,30)+'</label>'+button+'</div></div>';
				}
			} else {
				content += '<div class="no-record">No records found</div>';
			}
			...
			if(resp.length > 0) {
				...
				for(var j = 0;j < purBook.length;j++) {
					...
					purchasedBooks += '<div class="col-50 medium-25"><div class="econtent"><a href="javascript:;" '+attr+' class="epaper viewElibrary" '+attr+'><img src="'+purBook[j].image+'" onerror="this.src=\'assets/images/no-img.jpg\'" class="" alt=""></a><label class="ename">'+purBook[j].title.substr(0,30)+'</label>'+button+'</div></div>';
				}
...
function fileEncrption(options) {
	if(cordova.platformId == 'android') {
		...
		cordova.plugins.diagnostic.requestExternalStorageAuthorization(function(success) {
			path = ((success == cordova.plugins.diagnostic.permissionStatus.GRANTED) && typeof(cordova.file.externalSdCardDirectory) != 'undefined') ? cordova.file.externalSdCardDirectory : cordova.file.dataDirectory;
			encryptor.encrypt(path+'/'+file_name, password, function(encryptedFile) {
